...
import sprites.Multiplication.HardNumbers;
...
public class HardLevel {
    ...
    private HardNumbers numbers;
    private HardNumbers numbers1;
    private HardNumbers numbers2;
    private Hud hud;
    ...
    public HardLevel(SnakeGame snakeGame) {
        ...
        NumberQuestion = 1;
        numbers = new HardNumbers(boardSize, NumberQuestion);
        numbers1 = new HardNumbers(boardSize, 0);
        numbers2 = new HardNumbers(boardSize, 0);
    ...
    private void advance() {
        ...
        if(NumberQuestion>=27){
            score = Hud.score;
            snakeGame.setScreen(new GameOverScreenHard(snakeGame, score, sb, viewport));
        } if (Hud.worldTimer <= 0) {
            score = Hud.score;
            snakeGame.setScreen(new GameOverScreenHard(snakeGame, score, sb, viewport));
        }
