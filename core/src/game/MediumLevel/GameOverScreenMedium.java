...
public class GameOverScreenMedium implements Screen, InputProcessor {
    ...
    public GameOverScreenMedium(SnakeGame snakeGame, int score, SpriteBatch sb, Viewport viewport) {
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        ...
        if (backSprite.getBoundingRectangle().contains(pointerX, pointerY)) {
            ...
            sound();
            snakeGame.setScreen(new MediumScreen(snakeGame));
            dispose();
        }
        return true;
    }
