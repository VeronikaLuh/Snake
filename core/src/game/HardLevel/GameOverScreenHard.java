...
import game.EasyLevel.GameScreen;

public class GameOverScreenHard implements Screen, InputProcessor {
    ...
    public GameOverScreenHard(SnakeGame snakeGame, int score, SpriteBatch sb, Viewport viewport) {
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        ...
        if (backSprite.getBoundingRectangle().contains(pointerX, pointerY)) {
            ...
            sound();
            snakeGame.setScreen(new HardScreen(snakeGame));
            dispose();
        }
        return true;
    }
