...
import DivisionGame.LevelScreenDivision;

public class GOSDivisionMedium implements Screen, InputProcessor {
    ...
    public GOSDivisionMedium(SnakeGame snakeGame, int score, SpriteBatch sb, Viewport viewport) {
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        ...
        if (backSprite.getBoundingRectangle().contains(pointerX, pointerY)) {
            sound();
            snakeGame.setScreen(new LevelScreenDivision(snakeGame));
            dispose();
