...
import AdditionGame.Medium.GOSAdditionMedium;
import game.Hud;
import sprites.Addition.MediumNumbersAddition;
import sprites.Bodypart;
import sprites.Controls;
import sprites.Division.MediumNumbersDivision;
import sprites.Exmaple;

public class DivisionGameMedium {
    private int x;
    private int y;
    ...
    private MediumNumbersDivision numbers;
    private MediumNumbersDivision numbers1;
    private MediumNumbersDivision numbers2;
    private Hud hud;
    ...
    public DivisionGameMedium(SnakeGame snakeGame) {
        ...
        NumberQuestion = 1;
        numbers = new MediumNumbersDivision (boardSize, NumberQuestion);
        numbers1 = new MediumNumbersDivision(boardSize, 0);
        numbers2 = new MediumNumbersDivision(boardSize, 0);
    ...
    private void advance() {
        ...
        if(NumberQuestion>=22){
            score = Hud.score;
            snakeGame.setScreen(new GOSDivisionMedium(snakeGame, score, sb, viewport));
        }
         if (Hud.worldTimer <= 0) {
             score = Hud.score;
