...
public class MediumNumbersAddition {
    private int x;
    private int y;
    ...
    public MediumNumbersAddition(int boardSize, int NumberQuestion){
        ...
        if(NumberQuestion == 1){
            region = regions[28];
            Exmaple.example[0].setText("20+25");
        }
          if(NumberQuestion == 2){
            region = regions[35];
              Exmaple.example[0].setText("53+11");
          }
        if(NumberQuestion == 3){
            region = regions[36];
            Exmaple.example[0].setText("30+40");
        }
        if(NumberQuestion == 4){
            region = regions[21];
            Exmaple.example[0].setText("14+16");
        }
        if(NumberQuestion == 5){
            region = regions[37];
            Exmaple.example[0].setText("50+22");
        }
        if(NumberQuestion == 6){
            region = regions[15];
            Exmaple.example[0].setText("10+10");
        }
        if(NumberQuestion == 7){
            region = regions[34];
            Exmaple.example[0].setText("30+33");
        }
        if(NumberQuestion == 8){
            region = regions[30];
            Exmaple.example[0].setText("25+24");
        }
        if(NumberQuestion == 9){
            region = regions[26];
            Exmaple.example[0].setText("38+2");
        }
        if(NumberQuestion == 10){
            region = regions[38];
            Exmaple.example[0].setText("40+40");
        }
        if(NumberQuestion == 11){
            region = regions[32];
            Exmaple.example[0].setText("45+5");
        }
        if(NumberQuestion == 12){
            region = regions[17];
            Exmaple.example[0].setText("15+9");
        }
        if(NumberQuestion == 13){
            region = regions[12];
            Exmaple.example[0].setText("10+5");
        }
        if(NumberQuestion == 14){
            region = regions[26];
            Exmaple.example[0].setText("20+20");
        }
        if(NumberQuestion == 15){
            region = regions[38];
            Exmaple.example[0].setText("32+48");
        }
        if(NumberQuestion == 16){
            region = regions[27];
            Exmaple.example[0].setText("12+30");
        }
        if(NumberQuestion == 17){
            region = regions[35];
            Exmaple.example[0].setText("32+32");
        }
        if(NumberQuestion == 18){
            region = regions[30];
            Exmaple.example[0].setText("34+15");
        }
        ...
        if(NumberQuestion == 20){
            region = regions[19];
            Exmaple.example[0].setText("10+17");
        }
        if(NumberQuestion == 21){
            region = regions[25];
            Exmaple.example[0].setText("13+23");
        }
        if(NumberQuestion == 22){
            region = regions[39];
            Exmaple.example[0].setText("40+41");
        }
        if(NumberQuestion == 23){
            region = regions[37];
            Exmaple.example[0].setText("11+61");
        }
        if(NumberQuestion == 24){
            region = regions[28];
            Exmaple.example[0].setText("23+22");
        }
        if(NumberQuestion == 25){
            region = regions[24];
            Exmaple.example[0].setText("12+13");
        }
        if(NumberQuestion == 26){
            region = regions[22];
            Exmaple.example[0].setText("17+15");
        }
        if(NumberQuestion == 27){
            region = regions[29];
            Exmaple.example[0].setText("48+0");
        }
        if(NumberQuestion == 28){
            region = regions[36];
            Exmaple.example[0].setText("50+20");
        }
        if(NumberQuestion == 29){
            region = regions[38];
            Exmaple.example[0].setText("20+60");
        }
        if(NumberQuestion == 30){
            region = regions[31];
            Exmaple.example[0].setText("34+16");
        }
