...
import AdditionGame.Easy.GOSAdditionEasy;
import game.EasyLevel.GameOverScreen;
import game.Hud;
import sprites.Addition.EasyNumbersAddition;
import sprites.Addition.MediumNumbersAddition;
import sprites.Bodypart;
import sprites.Controls;
import sprites.Exmaple;

public class AdditionGameMedium {
    private int x;
    private int y;
    ...
    private MediumNumbersAddition numbers;
    private MediumNumbersAddition numbers1;
    private MediumNumbersAddition numbers2;
    private Hud hud;
    ...
    public AdditionGameMedium(SnakeGame snakeGame) {
        ...
        NumberQuestion = 1;
        numbers = new MediumNumbersAddition(boardSize, NumberQuestion);
        numbers1 = new MediumNumbersAddition(boardSize, 0);
        numbers2 = new MediumNumbersAddition(boardSize, 0);
    ...
    private void advance() {
        ...
        if(NumberQuestion>=31){
            score = Hud.score;
            snakeGame.setScreen(new GOSAdditionMedium(snakeGame, score, sb, viewport));
        }
         if (Hud.worldTimer <= 0) {
             score = Hud.score;

            snakeGame.setScreen(new GOSAdditionEasy(snakeGame, score, sb, viewport));
        }
