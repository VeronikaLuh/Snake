...
public class GOSAdditionHard implements Screen, InputProcessor {
    ...
    public GOSAdditionHard(SnakeGame snakeGame, int score, SpriteBatch sb, Viewport viewport) {
