...
public class Controls {
    ...
    public int getDirection () {
        ...
        if  ((Gdx.input.isKeyPressed(Input.Keys.UP) || Gdx.input.justTouched()  && touch.x < SnakeGame.WIDTH/2f && touch.x > 0 && currentDirection!= 2)) {
            nextDirection = 0;}

        else if (Gdx.input.isKeyPressed (Input.Keys.LEFT)||Gdx.input.justTouched()   && touch.x < SnakeGame.WIDTH/3f && touch.x < SnakeGame.WIDTH/2f && touch.x > 0 && currentDirection!= 3){ nextDirection = 1;}
