...
import game.EasyLevel.GameState;
...
public class HardScreen implements Screen {
    ...
    public HardScreen(SnakeGame snakeGame) {
        this.snakeGame = snakeGame;
        hardLevel = new HardLevel(snakeGame);
    ...
    public void render(float delta) {
        hardLevel.update(delta, viewport);
        camera.update ();
        viewport.apply ();
        Gdx.gl.glClear (GL20.GL_COLOR_BUFFER_BIT);
        hardLevel.draw(SnakeGame.WIDTH, SnakeGame.HEIGHT, camera);
