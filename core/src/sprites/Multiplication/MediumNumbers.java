...
public class MediumNumbers {
    ...
    public MediumNumbers(int boardSize, int NumberQuestion){
        ...
        if(NumberQuestion == 4){
            region = regions[25];
            Exmaple.example[0].setText("6*6");}
        if(NumberQuestion == 5){
            region = regions[15];
            Exmaple.example[0].setText("4*5");}
        if(NumberQuestion == 6){
            region = regions[28];
            Exmaple.example[0].setText("5*9");}
        if(NumberQuestion == 7){
            region = regions[5];
            Exmaple.example[0].setText("6*1");}
        if(NumberQuestion == 8){
            region = regions[21];
            Exmaple.example[0].setText("6*5");}
        if(NumberQuestion == 9){
            region = regions[25];
            Exmaple.example[0].setText("4*9");}
