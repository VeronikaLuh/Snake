...
import AdditionGame.LevelScreenAddition;

public class GOSAdditionMedium implements Screen, InputProcessor {
    ...
    public GOSAdditionMedium(SnakeGame snakeGame, int score, SpriteBatch sb, Viewport viewport) {
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        ...
        if (backSprite.getBoundingRectangle().contains(pointerX, pointerY)) {
            sound();
            snakeGame.setScreen(new LevelScreenAddition(snakeGame));
            dispose();
