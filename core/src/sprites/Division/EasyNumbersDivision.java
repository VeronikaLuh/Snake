...
public class EasyNumbersDivision {
    private int x;
    private int y;
    ...
    public EasyNumbersDivision(int boardSize, int NumberQuestion){
        ...
        if(NumberQuestion == 1){
          ...
          if(NumberQuestion == 2){
            region = regions[5];
              Exmaple.example[0].setText("12:2");
          }
        if(NumberQuestion == 3){
            region = regions[5];
        ...
        if(NumberQuestion == 4){
            region = regions[6];
            Exmaple.example[0].setText("21:3");
        }
        if(NumberQuestion == 5){
            region = regions[3];
        ...
        if(NumberQuestion == 6){
            region = regions[9];
            Exmaple.example[0].setText("15:3");
        }
        if(NumberQuestion == 7){
            region = regions[3];
        ...
        if(NumberQuestion == 8){
            region = regions[8];
            Exmaple.example[0].setText("18:2");
        }
        if(NumberQuestion == 9){
            region = regions[3];
            Exmaple.example[0].setText("12:3");
        }
        ...
        if(NumberQuestion == 11){
            region = regions[6];
            Exmaple.example[0].setText("14:2");
        }
        if(NumberQuestion == 12){
            region = regions[7];
            Exmaple.example[0].setText("24:3");
        }
        if(NumberQuestion == 13){
            region = regions[4];
            Exmaple.example[0].setText("5:1");
        }
        if(NumberQuestion == 14){
            region = regions[1];
            Exmaple.example[0].setText("4:2");
        }
        ...
        if(NumberQuestion == 17){
            region = regions[5];
            Exmaple.example[0].setText("10:2");
        }
        ...
        if(NumberQuestion == 19){
            region = regions[7];
            Exmaple.example[0].setText("16:2");
        }
