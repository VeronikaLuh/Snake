...
public class HardNumbersAddition {
    private int x;
    private int y;
    ...
    public HardNumbersAddition(int boardSize, int NumberQuestion){
        ...
        if(NumberQuestion == 1){
            region = regions[2];
            Exmaple.example[0].setText("1+1+1");
        }
          if(NumberQuestion == 2){
            region = regions[28];
              Exmaple.example[0].setText("25+5+10");
          }
        if(NumberQuestion == 3){
            region = regions[34];
            Exmaple.example[0].setText("5+6+52");
        }
        if(NumberQuestion == 4){
            region = regions[38];
            Exmaple.example[0].setText("20+20+20");
        }
        if(NumberQuestion == 5){
            region = regions[9];
            Exmaple.example[0].setText("1+5+4");
        }
        if(NumberQuestion == 6){
            region = regions[18];
            Exmaple.example[0].setText("7+8+10");
        }
        if(NumberQuestion == 7){
            region = regions[35];
            Exmaple.example[0].setText("10+44+10");
        }
        if(NumberQuestion == 8){
            region = regions[10];
            Exmaple.example[0].setText("10+1+1");
        }
        if(NumberQuestion == 9){
            region = regions[25];
            Exmaple.example[0].setText("12+12+12");
        }
        if(NumberQuestion == 10){
            region = regions[32];
            Exmaple.example[0].setText("43+10+1");
        }
        if(NumberQuestion == 11){
            region = regions[12];
            Exmaple.example[0].setText("5+9+2");
        }
        if(NumberQuestion == 12){
            region = regions[21];
            Exmaple.example[0].setText("8+17+5");
        }
        if(NumberQuestion == 13){
            region = regions[23];
            Exmaple.example[0].setText("19+13+3");
        }
        if(NumberQuestion == 14){
            region = regions[37];
            Exmaple.example[0].setText("50+21+1");
        }
        if(NumberQuestion == 15){
            region = regions[30];
            Exmaple.example[0].setText("23+12+14");
        }
        if(NumberQuestion == 16){
            region = regions[26];
            Exmaple.example[0].setText("10+10+20");
        }
        if(NumberQuestion == 17){
            region = regions[15];
            Exmaple.example[0].setText("12+5+3");
        }
        if(NumberQuestion == 18){
            region = regions[7];
            Exmaple.example[0].setText("2+2+2");
        }
        if(NumberQuestion == 19){
            region = regions[24];
            Exmaple.example[0].setText("6+14+15");
        }
        if(NumberQuestion == 20){
            region = regions[36];
            Exmaple.example[0].setText("35+15+20");
        }
        if(NumberQuestion == 21){
            region = regions[27];
            Exmaple.example[0].setText("12+12+18");
        }
        if(NumberQuestion == 22){
            region = regions[8];
            Exmaple.example[0].setText("3+3+3");
        }
        if(NumberQuestion == 23){
            region = regions[32];
            Exmaple.example[0].setText("21+25+10");
        }
        if(NumberQuestion == 24){
            region = regions[28];
            Exmaple.example[0].setText("15+15+15");
        }
        if(NumberQuestion == 25){
            region = regions[22];
            Exmaple.example[0].setText("23+7+2");
        }
