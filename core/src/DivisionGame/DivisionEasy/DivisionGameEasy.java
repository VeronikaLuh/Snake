...
import sprites.Division.EasyNumbersDivision;
import sprites.Exmaple;

public class DivisionGameEasy {
    private int x;
    private int y;
    ...
    private EasyNumbersDivision numbers;
    private EasyNumbersDivision numbers1;
    private EasyNumbersDivision numbers2;
    private Hud hud;
    ...
    public DivisionGameEasy(SnakeGame snakeGame) {
        ...
        NumberQuestion = 1;
        numbers = new EasyNumbersDivision(boardSize, NumberQuestion);
        numbers1 = new EasyNumbersDivision(boardSize, 0);
        numbers2 = new EasyNumbersDivision(boardSize, 0);
    ...
    private void advance() {
        ...
        if(NumberQuestion>=21){
            score = Hud.score;
            snakeGame.setScreen(new GOSDivisionEasy(snakeGame, score, sb, viewport));
        }
         if (Hud.worldTimer <= 0) {
             score = Hud.score;
            snakeGame.setScreen(new GOSDivisionEasy(snakeGame, score, sb, viewport));
