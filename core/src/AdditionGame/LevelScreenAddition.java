...
import game.HardLevel.HardScreen;
import game.MediumLevel.MediumScreen;

public class LevelScreenAddition implements Screen, InputProcessor {
    ...
    public LevelScreenAddition(SnakeGame snakeGame) {
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        ...
        if (backButtonSprite.getBoundingRectangle().contains(pointerX, pointerY)) {
            ...
            sound();
            snakeGame.setScreen(new AdditionScreenMedium(snakeGame));
        }
        else if (mediumButton.getBoundingRectangle().contains(pointerX, pointerY)) {
            sound();
            snakeGame.setScreen(new AdditionScreenMedium(snakeGame));
            ...
            sound();
            snakeGame.setScreen(new AdditionGame.Easy.AdditionScreenEasy(snakeGame));
            }
            ...
            sound();
            snakeGame.setScreen(new AdditionScreenEasy(snakeGame));
            dispose();}
        return true;
    }
    @Override
