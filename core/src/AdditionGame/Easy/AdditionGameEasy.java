...
public class AdditionGameEasy {
    ...
    private EasyNumbersAddition numbers;
    private EasyNumbersAddition numbers1;
    private EasyNumbersAddition numbers2;
    private Hud hud;
    ...
    public AdditionGameEasy(SnakeGame snakeGame) {
        ...
        NumberQuestion = 1;
        numbers = new EasyNumbersAddition(boardSize, NumberQuestion);
        numbers1 = new EasyNumbersAddition(boardSize, 0);
        numbers2 = new EasyNumbersAddition(boardSize, 0);
