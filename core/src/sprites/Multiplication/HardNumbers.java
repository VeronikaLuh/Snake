package sprites.Multiplication;
...
public class HardNumbers {
    ...
    public HardNumbers(int boardSize, int NumberQuestion){
        ...
        if(NumberQuestion == 1){
            region = regions[27];
            Exmaple.example[0].setText("7*6");
        }
          if(NumberQuestion == 2){
            region = regions[25];
              Exmaple.example[0].setText("9*4");
          }
        if(NumberQuestion == 3){
            region = regions[35];
            Exmaple.example[0].setText("8*8");
        }
        if(NumberQuestion == 4){
            region = regions[32];
            Exmaple.example[0].setText("9*6");
        }
        if(NumberQuestion == 5){
            region = regions[34];
        ...
        if(NumberQuestion == 6){
            region = regions[17];
            Exmaple.example[0].setText("8*3");
        }
        if(NumberQuestion == 7){
            region = regions[39];
            Exmaple.example[0].setText("9*9");
        }
        if(NumberQuestion == 8){
            region = regions[26];
            Exmaple.example[0].setText("8*5");
        }
        if(NumberQuestion == 9){
            region = regions[30];
        ...
        if(NumberQuestion == 11){
            region = regions[28];
            Exmaple.example[0].setText("9*5");
        }
        if(NumberQuestion == 12){
            region = regions[33];
            Exmaple.example[0].setText("8*7");
        }
        if(NumberQuestion == 13){
            region = regions[20];
            Exmaple.example[0].setText("7*4");
        }
        if(NumberQuestion == 14){
            region = regions[37];
            Exmaple.example[0].setText("9*8");
        }
        if(NumberQuestion == 15){
            region = regions[13];
            Exmaple.example[0].setText("8*2");
        }
        if(NumberQuestion == 16){
            region = regions[16];
            Exmaple.example[0].setText("7*3");
        }
        ...
        if(NumberQuestion == 20){
            region = regions[38];
            Exmaple.example[0].setText("8*10");
        }
        ...
        if(NumberQuestion == 23){
            region = regions[14];
            Exmaple.example[0].setText("9*2");
        }
        if(NumberQuestion == 24){
            region = regions[7];
            Exmaple.example[0].setText("8*1");
        }
        if(NumberQuestion == 25){
            region = regions[36];
            Exmaple.example[0].setText("7*10");
        }
