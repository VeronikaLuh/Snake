...
public class AdditionScreenHard implements Screen {
    private OrthographicCamera camera = new OrthographicCamera(SnakeGame.WIDTH, SnakeGame.HEIGHT);
    private Viewport viewport;
    private SnakeGame snakeGame;
    private AdditionGameHard gameState ;
    public static Texture background;
    private SpriteBatch sb;
    private Bodypart bodypart;


    public AdditionScreenHard(SnakeGame snakeGame) {
        this.snakeGame = snakeGame;
        gameState = new AdditionGameHard(snakeGame);
