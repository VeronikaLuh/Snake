...
import sprites.Multiplication.MediumNumbers;
...
public class MediumGame {
    ...
    private MediumNumbers numbers;
    private MediumNumbers numbers1;
    private MediumNumbers numbers2;
    private Hud hud;
    ...
    public MediumGame(SnakeGame snakeGame) {
        sb = new SpriteBatch();
        ...
        NumberQuestion = 1;
        score = 0;
        numbers = new MediumNumbers(boardSize, NumberQuestion);
        numbers1 = new MediumNumbers(boardSize, 0);
        numbers2 = new MediumNumbers(boardSize, 0);
    ...
    private void advance() {
        ...
        switch (controls.getDirection()) {
            ...
            if(NumberQuestion>= 22){
                score=Hud.score;
                snakeGame.setScreen(new GameOverScreenMedium(snakeGame, score, sb, viewport));
            }
        if (Hud.worldTimer <= 0) {
            score = Hud.score;
            snakeGame.setScreen(new GameOverScreenMedium(snakeGame, score, sb, viewport));
