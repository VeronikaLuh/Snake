...
public class MediumNumbersDivision {
    private int x;
    private int y;
    ...
    public MediumNumbersDivision(int boardSize, int NumberQuestion){
        ...
        if(NumberQuestion == 1){
            region = regions[7];
            Exmaple.example[0].setText("32:4");}
        if(NumberQuestion == 2){
            region = regions[2];
            Exmaple.example[0].setText("18:6");}
        if(NumberQuestion == 3){
            region = regions[4];
            Exmaple.example[0].setText("25:5");}
        if(NumberQuestion == 4){
            region = regions[5];
            Exmaple.example[0].setText("36:6");}
        if(NumberQuestion == 5){
            region = regions[3];
            Exmaple.example[0].setText("20:5");}
        if(NumberQuestion == 6){
            region = regions[8];
            Exmaple.example[0].setText("45:5");}
        if(NumberQuestion == 7){
            region = regions[5];
            Exmaple.example[0].setText("6:1");}
        if(NumberQuestion == 8){
            region = regions[4];
            Exmaple.example[0].setText("30:6");}
        if(NumberQuestion == 9){
            region = regions[8];
            Exmaple.example[0].setText("36:4");}
        if(NumberQuestion == 10){
            region = regions[2];
            Exmaple.example[0].setText("15:5");}
        if(NumberQuestion == 11){
            region = regions[3];
            Exmaple.example[0].setText("16:4");}
        if(NumberQuestion == 12){
            region = regions[7];
            Exmaple.example[0].setText("48:6");}
        if(NumberQuestion == 13){
            region = regions[8];
            Exmaple.example[0].setText("45:5");}
        if(NumberQuestion == 14){
            region = regions[5];
            Exmaple.example[0].setText("42:7");}
        if(NumberQuestion == 15){
            region = regions[3];
            Exmaple.example[0].setText("24:4");}
        if(NumberQuestion == 16){
            region = regions[1];
            Exmaple.example[0].setText("10:5");}
        if(NumberQuestion == 17){
            region = regions[9];
            Exmaple.example[0].setText("40:4");}
        if(NumberQuestion == 18){
            region = regions[8];
            Exmaple.example[0].setText("54:6");}
        if(NumberQuestion == 19){
            region = regions[6];
            Exmaple.example[0].setText("35:5");}
        if(NumberQuestion == 20){
            region = regions[3];
            Exmaple.example[0].setText("28:7");}
        if(NumberQuestion == 21){
            region = regions[4];
            Exmaple.example[0].setText("50:10");}
